    ...
    <script type="text/javascript">
        $(document).ready(function () {
            oTable = $('#listResults').DataTable({
                ...
                "serverSide": true,
                "order": [[0, "DESC"]],
                "ajax": "{{route('admin.posts.listing')}}",
                "columns": [
                    ...
                    {"data": "likes", searchable: false, sortable: false},
                    {"data": "comment", searchable: false, sortable: false},
                    //{"data": "comment_likes", searchable: false, sortable: false},
